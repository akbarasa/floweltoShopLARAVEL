                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/updatepassword')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="oldpassword" type="password" class="form-control @error('oldpassword') is-invalid @enderror" name="oldpassword" required autocomplete="new-oldpassword">
                        ...
                        <div class="form-group row">
                            ...
                            <span class="help-block" >
                                <center><span class="lead" style="color: red;">{{ $errors->first() }}</span><center>
                            </span>
                            @endif
